...
CUDA_VISIBLE_DEVICES=0,1,3,4 python3 -m torch.distributed.launch --nproc_per_node=4 \
--use_env train.py --batch_size 1 --dataset nyudepthv2 --data_path ./ \
 ...
 --shift_size 2 --save_model --layer_decay 0.9 --drop_path_rate 0.3 --log_dir $1 \
  --crop_h 480 --crop_w 480 --epochs 30 --resume-from /ssd/ll/VPD/depth/checkpoints/epoch_25_model.ckpt ${@:2}